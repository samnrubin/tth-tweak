...
void SetupScrolls(CRules@ this)
{
	...
	const f32 m = 8.0f;  //multiply production time by 8
	...
	// these are used merely for rendering the tree
...

	{
		...
		addScrollItemsToArray( "Arrows", "mat_arrows", 	m*2, false, 3, @def.items );
